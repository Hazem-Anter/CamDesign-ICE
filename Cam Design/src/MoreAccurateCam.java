...
public void bk() {
		...
		B2 = (int)Math.ceil((9*seta)/128);
		B3 = (int)Math.ceil((9*seta)/128);
		B4 = (int)Math.ceil((9*seta)/128);
		B5 = (int)Math.ceil((9*seta)/128);
		B6 = (int)Math.ceil((3*seta)/32);
		B7 = (int)Math.ceil((3*seta)/32);
